...
void GUI_initGlobalStyles() {
  ...
  lv_style_set_bg_color(&GUI_Style__class_8rQJj2WR7KS5BW__,
                        lv_color_make(0, 0, 95));
  lv_style_set_bg_opa(&GUI_Style__class_8rQJj2WR7KS5BW__, 0);
  lv_style_set_radius(&GUI_Style__class_8rQJj2WR7KS5BW__, 0);

  lv_style_init(&GUI_Style__class_votutC5OWpgnlu__);
  lv_style_set_opa(&GUI_Style__class_votutC5OWpgnlu__, 255);
