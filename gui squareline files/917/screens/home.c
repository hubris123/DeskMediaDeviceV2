...
void GUI_initScreen__home() {
  ...
  lv_obj_set_pos(GUI_Container__home__main_display_cont, 2, -141);
  lv_obj_set_size(GUI_Container__home__main_display_cont, 210, 181);
  ...
  lv_obj_set_align(GUI_Container__home__NETWORKSTAUSANDMENUCONT,
                   LV_ALIGN_CENTER);
  lv_obj_set_pos(GUI_Container__home__NETWORKSTAUSANDMENUCONT, 388, -231);
