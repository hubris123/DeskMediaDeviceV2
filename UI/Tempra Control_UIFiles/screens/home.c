...
void GUI_initScreen__home() {
  ...
  lv_obj_set_pos(GUI_Container__home__details_cont, -11, 220);
  ...
  GUI_Label__home__hourly_forecast_title_lbl =
      lv_label_create(GUI_Container__home__hourly_forecast_title_cont);
  lv_label_set_long_mode(GUI_Label__home__hourly_forecast_title_lbl,
                         LV_LABEL_LONG_WRAP);
  lv_obj_set_align(GUI_Label__home__hourly_forecast_title_lbl,
                   LV_ALIGN_LEFT_MID);
  lv_obj_set_pos(GUI_Label__home__hourly_forecast_title_lbl, 1, 5);
  lv_obj_set_size(GUI_Label__home__hourly_forecast_title_lbl, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT);
  ...
  GUI_Label__home__POLLENCOUNTQ =
      lv_label_create(GUI_Container__home__hourly_forecast_title_cont);
  lv_label_set_long_mode(GUI_Label__home__POLLENCOUNTQ, LV_LABEL_LONG_WRAP);
  lv_obj_set_align(GUI_Label__home__POLLENCOUNTQ, LV_ALIGN_LEFT_MID);
  lv_obj_set_pos(GUI_Label__home__POLLENCOUNTQ, 41, 45);
  lv_obj_set_size(GUI_Label__home__POLLENCOUNTQ, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT);
  ...
  lv_obj_set_size(GUI_Image__home__HR1FORCASICON22X22Q, 22, 22);
...
void GUI_initScreenTexts__home() {
  ...
  lv_label_set_text(GUI_Label__home__hourly_forecast_title_lbl, "Next 5hrs");
  lv_label_set_text(GUI_Label__home__pollen_count_title, "Pollen Count");
  lv_label_set_text(GUI_Label__home__POLLENCOUNTQ, "6.5");
...
void GUI_initScreenStyles__home() {
  ...
  lv_obj_add_style(GUI_Label__home__hourly_forecast_title_lbl,
                   &GUI_Style__class_RGR5O50FZk8MjD__,
                   LV_PART_MAIN | LV_STATE_DEFAULT);
  ui_object_set_themeable_style_property(
      GUI_Label__home__hourly_forecast_title_lbl,
      LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_COLOR,
  ...
  lv_obj_add_style(GUI_Label__home__POLLENCOUNTQ,
                   &GUI_Style__class_orAle4UexZ0qwV__,
                   LV_PART_MAIN | LV_STATE_DEFAULT);
  ui_object_set_themeable_style_property(
      GUI_Label__home__POLLENCOUNTQ, LV_PART_MAIN | LV_STATE_DEFAULT,
      LV_STYLE_TEXT_COLOR, _ui_theme_bg_color_white);
  ui_object_set_themeable_style_property(
      GUI_Label__home__POLLENCOUNTQ, LV_PART_MAIN | LV_STATE_DEFAULT,
      LV_STYLE_TEXT_OPA, _ui_theme_bg_opa_white);
