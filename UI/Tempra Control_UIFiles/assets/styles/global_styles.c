...
void GUI_initGlobalStyles() {
  ...
  lv_style_set_pad_top(&GUI_Style__class_l2KF3gLqvrvgNA__, 12);
  ...
  lv_style_set_text_font(&GUI_Style__class_l05DXbHrWKpOYP__, &weather_now);
  ...
  lv_style_set_text_font(&GUI_Style__class_OWp7o3fr8u7nZG__, &weather_now);
  ...
  lv_style_init(&GUI_Style__class_RGR5O50FZk8MjD__);
  lv_style_set_text_font(&GUI_Style__class_RGR5O50FZk8MjD__, &label_1);
  lv_style_set_text_color(&GUI_Style__class_RGR5O50FZk8MjD__,
                          lv_color_make(255, 255, 255));
  lv_style_set_text_opa(&GUI_Style__class_RGR5O50FZk8MjD__, 255);
  lv_style_set_text_letter_space(&GUI_Style__class_RGR5O50FZk8MjD__, 0);
  lv_style_set_text_line_space(&GUI_Style__class_RGR5O50FZk8MjD__, 0);
  lv_style_set_text_align(&GUI_Style__class_RGR5O50FZk8MjD__,
                          LV_TEXT_ALIGN_LEFT);
  ...
  lv_style_set_pad_left(&GUI_Style__class_ePErXDcnIvioYq__, 32);
  ...
  lv_style_set_flex_flow(&GUI_Style__class_AvvcYB4wlpzNqr__, LV_FLEX_FLOW_ROW);
  lv_style_set_flex_main_place(&GUI_Style__class_AvvcYB4wlpzNqr__,
                               LV_FLEX_ALIGN_CENTER);
  lv_style_set_flex_track_place(&GUI_Style__class_AvvcYB4wlpzNqr__,
                                LV_FLEX_ALIGN_START);
  lv_style_set_flex_cross_place(&GUI_Style__class_AvvcYB4wlpzNqr__,
                                LV_FLEX_ALIGN_START);
  lv_style_set_pad_row(&GUI_Style__class_AvvcYB4wlpzNqr__, 0);
  lv_style_set_pad_column(&GUI_Style__class_AvvcYB4wlpzNqr__, 0);
  lv_style_set_layout(&GUI_Style__class_AvvcYB4wlpzNqr__, LV_LAYOUT_FLEX);
  ...
  lv_style_set_flex_flow(&GUI_Style__class_dVaeR4MlNk6JVP__, LV_FLEX_FLOW_ROW);
  lv_style_set_flex_main_place(&GUI_Style__class_dVaeR4MlNk6JVP__,
                               LV_FLEX_ALIGN_CENTER);
  lv_style_set_flex_track_place(&GUI_Style__class_dVaeR4MlNk6JVP__,
                                LV_FLEX_ALIGN_START);
  lv_style_set_flex_cross_place(&GUI_Style__class_dVaeR4MlNk6JVP__,
                                LV_FLEX_ALIGN_START);
  lv_style_set_pad_row(&GUI_Style__class_dVaeR4MlNk6JVP__, 0);
  lv_style_set_pad_column(&GUI_Style__class_dVaeR4MlNk6JVP__, 0);
  lv_style_set_layout(&GUI_Style__class_dVaeR4MlNk6JVP__, LV_LAYOUT_FLEX);
