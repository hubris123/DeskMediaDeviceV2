...
void GUI_initScreen__keyboardzipcode() {
  ...
  lv_obj_set_size(GUI_Keyboard__keyboardzipcode__keyboardzip, 740, 362);
  ...
  lv_obj_set_align(GUI_Container__keyboardzipcode__container_12,
                   LV_ALIGN_CENTER);
  lv_obj_set_size(GUI_Container__keyboardzipcode__container_12, 302, 37);
  ...
  lv_obj_set_size(GUI_Button__keyboardzipcode__button_5, 102, 28);
  ...
  lv_obj_set_size(GUI_Button__keyboardzipcode__button_4, 102, 28);
