...
void GUI_initScreen__networkselector() {
  ...
  lv_obj_set_align(GUI_Container__networkselector__container_10,
                   LV_ALIGN_CENTER);
  lv_obj_set_pos(GUI_Container__networkselector__container_10, 215, -37);
  ...
  GUI_Container__networkselector__container_13 =
      lv_obj_create(GUI_Panel__networkselector__panel_2);
  lv_obj_remove_style_all(GUI_Container__networkselector__container_13);
  lv_obj_remove_flag(GUI_Container__networkselector__container_13,
                     LV_OBJ_FLAG_CLICKABLE);
  lv_obj_remove_flag(GUI_Container__networkselector__container_13,
                     LV_OBJ_FLAG_SCROLLABLE);
  lv_obj_set_align(GUI_Container__networkselector__container_13,
                   LV_ALIGN_CENTER);
  lv_obj_set_size(GUI_Container__networkselector__container_13, 302, 37);

  GUI_Button__networkselector__button_7 =
      lv_button_create(GUI_Container__networkselector__container_13);
  lv_obj_set_align(GUI_Button__networkselector__button_7, LV_ALIGN_CENTER);
  lv_obj_set_size(GUI_Button__networkselector__button_7, 102, 28);
  ...
  lv_obj_set_size(GUI_Button__networkselector__button_6, 102, 28);
...
void GUI_initScreenStyles__networkselector() {
  ...
  lv_obj_add_style(GUI_Container__networkselector__container_13,
                   &GUI_Style__class_ddJcy0PZRiVhu1__,
                   LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_add_style(GUI_Button__networkselector__button_7,
                   &GUI_Style__class_1aTDzshajO9dKi__,
                   LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_add_style(GUI_Label__networkselector__label_14,
                   &GUI_Style__class_bH6lQLxPISysIy__,
                   LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_add_style(GUI_Button__networkselector__button_6,
                   &GUI_Style__class_UfvGqtj4LNg70F__,
                   LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_add_style(GUI_Label__networkselector__label_13,
                   &GUI_Style__class_xt6pGh28xe2gYG__,
                   LV_PART_MAIN | LV_STATE_DEFAULT);
}
