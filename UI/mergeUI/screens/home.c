...
void GUI_initScreen__home() {
  ...
  lv_obj_remove_flag(GUI_Container__home__musicbuttoncont,
                     LV_OBJ_FLAG_CLICKABLE);
  lv_obj_remove_flag(GUI_Container__home__musicbuttoncont,
                     LV_OBJ_FLAG_SCROLLABLE);
  ...
  GUI_Panel__home__musicbuttonpanel =
      lv_obj_create(GUI_Container__home__musicbuttoncont);
  ...
  GUI_Button__home__musicbuttongrey =
      lv_button_create(GUI_Panel__home__musicbuttonpanel);
  ...
  GUI_Image__home__musicbtn =
      lv_image_create(GUI_Button__home__musicbuttongrey);
...
void GUI_initScreenStyles__home() {
  ...
  lv_obj_add_style(GUI_Panel__home__musicscrollbg,
                   &GUI_Style__class_jyulY1Pqi8nomS__homepanelsgreydrop,
                   LV_PART_MAIN | LV_STATE_DEFAULT);
  ui_object_set_themeable_style_property(
      GUI_Panel__home__musicscrollbg, LV_PART_MAIN | LV_STATE_DEFAULT,
      LV_STYLE_SHADOW_COLOR, _ui_theme_bg_color_dark_gray);
  ui_object_set_themeable_style_property(
      GUI_Panel__home__musicscrollbg, LV_PART_MAIN | LV_STATE_DEFAULT,
      LV_STYLE_SHADOW_OPA, _ui_theme_bg_opa_dark_gray);
  lv_obj_add_style(GUI_Panel__home__musicscrollbg,
                   &GUI_Style__class_5bE6Rj3PdUsKzR__,
                   LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_add_style(GUI_Label__home__musicscrolllabel,
                   &GUI_Style__class_wCVCeNc0Hy2Pc9__,
                   LV_PART_MAIN | LV_STATE_DEFAULT);
  ui_object_set_themeable_style_property(
      GUI_Label__home__musicscrolllabel, LV_PART_MAIN | LV_STATE_DEFAULT,
