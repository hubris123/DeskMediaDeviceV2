...
void GUI_initScreen__settingswindow() {
  ...
  lv_obj_set_size(GUI_Container__settingswindow__container_3, 800, 480);
  ...
  lv_obj_set_size(GUI_Panel__settingswindow__panel_1, 450, 465);
  ...
  lv_obj_set_size(GUI_Container__settingswindow__container_4, 500, 460);
  ...
  lv_obj_set_pos(GUI_Label__settingswindow__labelsettings, 2, -200);
  lv_obj_set_size(GUI_Label__settingswindow__labelsettings, LV_SIZE_CONTENT,
                  LV_SIZE_CONTENT);

  GUI_Container__settingswindow__container_15 =
      lv_obj_create(GUI_Container__settingswindow__container_4);
  lv_obj_remove_style_all(GUI_Container__settingswindow__container_15);
  lv_obj_remove_flag(GUI_Container__settingswindow__container_15,
                     LV_OBJ_FLAG_CLICKABLE);
  lv_obj_remove_flag(GUI_Container__settingswindow__container_15,
                     LV_OBJ_FLAG_SCROLLABLE);
  lv_obj_set_align(GUI_Container__settingswindow__container_15,
                   LV_ALIGN_CENTER);
  lv_obj_set_pos(GUI_Container__settingswindow__container_15, -13, -93);
  lv_obj_set_size(GUI_Container__settingswindow__container_15, 315, 167);

  GUI_Checkbox__settingswindow__checkbox =
      lv_checkbox_create(GUI_Container__settingswindow__container_15);
  ...
  GUI_Label__settingswindow__label =
      lv_label_create(GUI_Container__settingswindow__container_15);
  ...
  GUI_Slider__settingswindow__slider =
      lv_slider_create(GUI_Container__settingswindow__container_15);
  ...
  GUI_Container__settingswindow__container_16 =
      lv_obj_create(GUI_Container__settingswindow__container_4);
  lv_obj_remove_style_all(GUI_Container__settingswindow__container_16);
  lv_obj_remove_flag(GUI_Container__settingswindow__container_16,
                     LV_OBJ_FLAG_CLICKABLE);
  lv_obj_remove_flag(GUI_Container__settingswindow__container_16,
                     LV_OBJ_FLAG_SCROLLABLE);
  lv_obj_set_align(GUI_Container__settingswindow__container_16,
                   LV_ALIGN_CENTER);
  lv_obj_set_pos(GUI_Container__settingswindow__container_16, -10, 69);
  lv_obj_set_size(GUI_Container__settingswindow__container_16, 353, 166);

  GUI_Label__settingswindow__label_3 =
      lv_label_create(GUI_Container__settingswindow__container_16);
  ...
  GUI_Container__settingswindow__container_6 =
      lv_obj_create(GUI_Container__settingswindow__container_16);
  ...
  lv_obj_set_size(GUI_Container__settingswindow__container_6, 296, 40);
  ...
  lv_obj_set_size(GUI_Textarea__settingswindow__textarea_1, 130, 25);
  ...
  lv_obj_set_size(GUI_Container__settingswindow__container_8, 296, 40);
  ...
  lv_obj_set_size(GUI_Textarea__settingswindow__textarea_2, 180, 25);
  ...
  lv_obj_set_size(GUI_Container__settingswindow__container_9, 299, 35);
  ...
  lv_obj_set_size(GUI_Textarea__settingswindow__textarea_3, 172, 25);
  ...
  lv_obj_set_y(GUI_Container__settingswindow__container_7, 193);
  lv_obj_set_size(GUI_Container__settingswindow__container_7, 596, 62);

  GUI_Button__settingswindow__button_8 =
      lv_button_create(GUI_Container__settingswindow__container_7);
  lv_obj_set_align(GUI_Button__settingswindow__button_8, LV_ALIGN_CENTER);
  lv_obj_set_size(GUI_Button__settingswindow__button_8, 120, 50);

  GUI_Label__settingswindow__label_5 =
      lv_label_create(GUI_Button__settingswindow__button_8);
  ...
  lv_obj_set_size(GUI_Button__settingswindow__button_1, 120, 50);

  GUI_Label__settingswindow__label_2 =
      lv_label_create(GUI_Button__settingswindow__button_1);
  lv_obj_add_flag(GUI_Label__settingswindow__label_2, LV_OBJ_FLAG_CLICKABLE);
...
void GUI_initScreenTexts__settingswindow() {
  ...
  lv_label_set_text(GUI_Label__settingswindow__label_5, "SAVE");
  lv_label_set_text(GUI_Label__settingswindow__label_2, "EXIT");
}
...
void GUI_initScreenStyles__settingswindow() {
  ...
  ui_object_set_themeable_style_property(
      GUI_Panel__settingswindow__panel_1, LV_PART_MAIN | LV_STATE_DEFAULT,
  ...
  lv_obj_add_style(GUI_Container__settingswindow__container_15,
                   &GUI_Style__class_WEVkYUZKphwXIY__,
                   LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_add_style(GUI_Container__settingswindow__container_16,
                   &GUI_Style__class_bEwEjPfvF2IHLl__,
                   LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_add_style(GUI_Container__settingswindow__container_7,
                   &GUI_Style__class_UtTCsRwFAEV8hf__,
                   LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_add_style(GUI_Button__settingswindow__button_8,
                   &GUI_Style__class_V44bb0Z3JHdHzw__,
                   LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_add_style(GUI_Label__settingswindow__label_5,
                   &GUI_Style__class_D644wxpfWBY58v__,
                   LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_add_style(GUI_Button__settingswindow__button_1,
                   &GUI_Style__class_NA9r6BEuUHzdhT__,
                   LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_add_style(GUI_Label__settingswindow__label_2,
                   &GUI_Style__class_jb2Uogg83p0stH__,
                   LV_PART_MAIN | LV_STATE_DEFAULT);
}
